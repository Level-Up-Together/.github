...
|------------|-------------|
| `mvp-backend` | MVP Backend API Server |
| `mvp-front` | MVP Web Frontend |
| `admin-backend` | Admin Backend API Server |
| `admin-front` | Admin Web Frontend |
| `react-native` | Mobile Application (React Native) |
